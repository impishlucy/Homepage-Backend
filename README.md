...
The backend provides structured portfolio data for:
...
Admin functionality is intended to be protected with Discord login.

Make sure the required Discord application credentials and callback URLs are configured before deploying.

## Environment

Configure the backend using environment variables or application settings.
...
- Backend on the API subdomain
- HTTPS enabled through a reverse proxy
